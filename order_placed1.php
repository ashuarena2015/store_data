  ...
  $json = file_get_contents('php://input');
	...
	if($_POST['email_update']!=''){
	  if($num < 1){	  
		...
		$message .= "<tr><td colspan='4' style='border:1px solid #e2e2e2; padding:10px;'><h3>".$res3['name']."</h3>";
		if($_POST['defaultAddress']==1){
		 ...
		 $message .= "<tr><td style='border:1px solid #e2e2e2; padding:10px;' colspan='4'>Order No. - <b>".$orderid."</b> Date: <b>".$date."</b></td></tr>";
		 $message .= "<tr><td style='border:1px solid #e2e2e2; padding:10px;'>#</td><td style='border:1px solid #e2e2e2; padding:10px;'>Product Name</td><td style='border:1px solid #e2e2e2; padding:10px;'>Qty</td><td style='border:1px solid #e2e2e2; padding:10px;'>Price (In Rs.)</td></tr>";
		 $k=0; 
		 $sql = mysql_query("select * from orders where order_id='".$_POST['orderID']."'");
		 while($res = mysql_fetch_array($sql)){
		 $k++;
		$message .= "<tr><td style='border:1px solid #e2e2e2; padding:10px;'>".$k."</td><td style='border:1px solid #e2e2e2; padding:10px;'>".$res['pro_name']."</td><td style='border:1px solid #e2e2e2; padding:10px;'>".$res['pro_qty']."</td><td style='border:1px solid #e2e2e2; padding:10px;'>".$res['pro_price']."</td></tr>";
		 }
		...
		$message .= "<tr><td colspan='2' style='border:1px solid #e2e2e2; padding:10px;'><td style='border:1px solid #e2e2e2; padding:10px;'>Shipping: </td></td><td style='border:1px solid #e2e2e2; padding:10px;' colspan='4'><b>".$shipping."</b></td></tr>";
		$message .= "<tr><td colspan='2' style='border:1px solid #e2e2e2; padding:10px;'><td style='border:1px solid #e2e2e2; padding:10px;'>Tax: </td></td><td style='border:1px solid #e2e2e2; padding:10px;' colspan='4'><b>".$tax."</b></td></tr>";
		$message .= "<tr><td colspan='2' style='border:1px solid #e2e2e2; padding:10px;'><td style='border:1px solid #e2e2e2; padding:10px;'>Tax Rate: </td></td><td style='border:1px solid #e2e2e2; padding:10px;' colspan='4'><b>".$taxRate."%</b></td></tr>";
		
		$message .= "<tr><td colspan='2' style='border:1px solid #e2e2e2; padding:10px;'><td style='border:1px solid #e2e2e2; padding:10px;'>Total: </td></td><td style='border:1px solid #e2e2e2; padding:10px;' colspan='4'><b>".$totalPriceAfterTaxAndShipping."</b></td></tr>"; 		
		$message .= "</table>";
		$message .= '</body></html>';
